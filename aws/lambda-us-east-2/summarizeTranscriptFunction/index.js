...
export const handler = async (event) => {
    ...
    try {
        ...
        const completion = await openai.chat.completions.create({
            ...
            messages: [
                {"role": "system", "content": "You are a sales manager supervising one of your employees as they pitch a sale."},
                {"role": "user", "content": `In less than 250 words, summarize this conversation between your salesman/woman and a potential customer. Start with: "[employee name] pitched [product/service] to [customer name], [additional customer information]". Then provide 1-3 examples of what the employee did well during the sales interaction. Then provide 1-2 critiques of what could have been done better. One sentence for each example. Lastly, offer advice on how the employee can improve their sales strategy. 3 sentences max. ${textToSummarize}`},
            ]
        });
